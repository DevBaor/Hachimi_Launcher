...
import "./settings-downloads.scss";
...
export function SettingsContextDownloads() {
  ...
  return (
    <div className="settings-context-panel">
      ...
      <div className="settings-context-panel__group">
        <h3>{t("download_install_guide")}</h3>

        <div className="settings-downloads__guide">
          <p className="settings-downloads__guide-intro">
            {t("download_install_guide_intro")}
          </p>

          <ol className="settings-downloads__guide-list">
            <li>{t("download_install_guide_step_1")}</li>
            <li>{t("download_install_guide_step_2")}</li>
            <li>{t("download_install_guide_step_3")}</li>
            <li>{t("download_install_guide_step_4")}</li>
            <li>{t("download_install_guide_step_5")}</li>
          </ol>

          <p className="settings-downloads__guide-note">
            {t("download_install_guide_note")}
          </p>
        </div>
      </div>

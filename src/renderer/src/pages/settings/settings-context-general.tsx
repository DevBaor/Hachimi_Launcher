...
export function SettingsContextGeneral({}: Readonly<SettingsContextGeneralProps>) {
  ...
  return (
    <div className="settings-context-panel">
      ...
      <div className="settings-context-panel__group">
        ...
        <p className="settings-context-panel__restart-description">
          {t("restart_hachimi_description")}
        </p>

        <Button
          className="settings-context-panel__restart-button"
          onClick={() => {
            void window.electron.restartApp();
          }}
        >
          <SyncIcon />
          {t("restart_hachimi")}
